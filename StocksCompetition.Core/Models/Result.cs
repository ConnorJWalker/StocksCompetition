namespace StocksCompetition.Core.Models;
...
public record Result<T>
{
    ...
    public static Result<T> FromSuccess(T content) 
        => new Result<T> { Success = true, Content = content, ErrorMessage = string.Empty, ErrorCode = 0 };
    ...
    public static Result<T> FromFailed(int errorCode, string errorMessage) 
        => new Result<T> { Success = false, ErrorCode = errorCode, ErrorMessage = errorMessage };
}